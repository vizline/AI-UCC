...
let state = {participantId:crypto.randomUUID(),startedAt:null,condition:null,demographics:{},responses:{},timings:{},procedureOpenedAt:Date.now(),pageOpenedAt:null,activeTimingKey:null,page:0,sections:[]};
